...
export default function Footer () {
  return (
    <div className='footer'>
        <p>Developed by <a className='creators' target='Dennis' href='https://www.dennishesler.com.ar'>Hesler Dennis</a> & <a className='creators' target='Joanthan' href='https://jonathanpelinski.vercel.app'>Jonathan Pelinski</a> </p>
